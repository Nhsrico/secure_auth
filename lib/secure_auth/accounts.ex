defmodule SecureAuth.Accounts do
  @moduledoc """
  ...
  See `SecureAuth.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  ## Examples
      ...
      iex> deliver_user_update_email_instructions(user, current_email, &url(~p"/users/settings/confirm-email/#{&url(~p"/users/settings/confirm-email/#{&1}")1}"))
      {:ok, %{to: ..., body: ...}}
